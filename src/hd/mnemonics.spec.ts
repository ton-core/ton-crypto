...
import { mnemonicToHDSeed, mnemonicValidate } from "../mnemonic/mnemonic";
import { deriveMnemonicsPath } from "./mnemonics";
...
describe('mnemonics', () => {
    for (let tv of testVectors) {
        it('should match test vector seed #' + tv.id, async () => {
            ...
            // Check seed
            expect(await mnemonicValidate(tv.root)).toBe(true);
