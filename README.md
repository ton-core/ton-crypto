...
**This repository has been deprecated and is no longer actively maintained.** We have moved our project to a new repository, which you can find here: [ton-org/ton-crypto](https://github.com/ton-org/ton-crypto). The new NPM reposity is available here: [@ton/crypto](https://www.npmjs.com/package/@ton/crypto)
